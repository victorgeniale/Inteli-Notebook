# O que é ser ágil
> Criação em um menor período de tempo atrelada à adaptabilidade
- Colaboração de indivíduos > Ferramentas disponíveis;
- Entregas (Produto feito na prática) > Documentação (Teoria);
- Participação do cliente > Contratos;
- Adaptação as mudanças > Seguir um plano cegamente;

# Scrum
- Sprint: Período determinado para executar uma tarefa, resultando em um entregável;
